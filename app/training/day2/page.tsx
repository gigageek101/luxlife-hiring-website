        ...
        <div className="container max-w-4xl">
          ...
          >
            ...
            <div>
              ...
              <a
                href="https://pentagonal-thief-156.notion.site/Chatting-Course-DAY-2-24eb6586b06d80408e73edf2790df098?source=copy_link"
                target="_blank"
                rel="noopener noreferrer"
                className="btn-primary hover-lift text-lg px-8 py-4 inline-flex items-center gap-3 w-full justify-center"
              >
                <ExternalLink className="w-5 h-5" />
                Open Day 2 Training Videos
              </a>
            </div>
            ...
            <div className="text-center pt-6 border-t border-gray-200">
              <p className="text-lg mb-4" style={{ color: 'var(--text-secondary-on-white)' }}>
                After passing Day 2, check Telegram for admin approval to continue
              </p>
              <Link
                href="/training"
