...
const questions: Question[] = [
  {
    id: 1,
    question: "What did I explain about the importance of building relationships in the upselling process?",
    correctAnswer: "Building relationships with subscribers is the most crucial part of the upselling process. It helps to establish trust and rapport, which can lead to more sales in the future."
  },
  {
    id: 2,
    question: "What was the main strategy discussed for escalating the conversation?",
    correctAnswer: "The main strategy for escalating the conversation involves a step-by-step process, starting from a casual conversation and gradually moving into a sexting session."
  },
  {
    id: 3,
    question: "Why is aftercare important after selling PPV content?",
    correctAnswer: "Because it helps ensure a positive emotional experience, strengthens the relationship, and reduces negative feelings such as buyer's remorse."
  },
  {
    id: 4,
    question: "How does aftercare help prevent buyer's remorse?",
    correctAnswer: "By reassuring subscribers, affirming their decision, and making them feel that their purchase was valuable and worthwhile."
  },
  {
    id: 5,
    question: "How does aftercare contribute to long-term subscriber loyalty?",
    correctAnswer: "By making subscribers feel valued, emotionally supported, and connected, which increases retention and future purchases."
  },
  {
    id: 6,
    question: "What was the advice given about interacting with new subscribers?",
    correctAnswer: "The advice given was to engage with new subscribers by thanking them for subscribing and trying to build a relationship with them."
  }
]

export default function TrainingDay4() {
        ...
        <div className="container max-w-4xl">
          <Reveal>
            <div className="text-center mb-12">
              <h1 className="mb-4">
                Training Day 4 Assessment
              </h1>
              <p className="text-xl" style={{ color: 'var(--text-secondary-on-white)' }}>
                Complete this assessment to test your understanding of upselling, relationship building, and aftercare
              </p>
            </div>
          </Reveal>
